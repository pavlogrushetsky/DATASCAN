    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("General.Customers", t => t.CustomerId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("General.Estimators", t => t.EstimatorId, cascadeDelete: true)
                .ForeignKey("General.MeasurePoints", t => t.MeasurePointId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("Scan.Scans", t => t.ScanId, cascadeDelete: true)
                .ForeignKey("Scan.SheduledScans", t => t.ScheduledScan_Id)
                .Index(t => t.ScanId)
            ...
            CreateTable(
                ...
                .ForeignKey("Scan.Periods", t => t.ScanPeriodId, cascadeDelete: true)
                .Index(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("Scan.Periods", "ScheduledScan_Id", "Scan.SheduledScans");
